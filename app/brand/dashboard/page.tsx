      ...
      <div className="relative flex flex-col gap-6 md:flex-row md:items-center md:justify-between border-b border-white/5 pb-8">
        ...
        <div>
          ...
          <p className="text-xs text-slate-400 mt-1 max-w-xl leading-relaxed">
            Kết nối thông minh nhãn hàng với các biểu tượng sắc đẹp hàng đầu Việt Nam thông qua dữ liệu số và quy trình giao dịch ký quỹ an toàn 24h.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-12">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="min-w-0 flex-1">
                    <h4 className="text-xs font-black text-white group-hover:text-amber-300 transition-colors flex items-center gap-1.5">
                      3 Booking Mới Chờ Ký Quỹ <ArrowUpRight className="h-3.5 w-3.5 opacity-0 group-hover:opacity-100 transition-opacity" />
                    </h4>
                    <p className="text-[10px] text-slate-500 mt-1 leading-relaxed">Người mẫu đã xác nhận, nhấp để thực hiện ký quỹ ví cọc bảo đảm.</p>
                  </div>
                </div>
              </div>
        ...
        <div className="space-y-8 lg:col-span-4">
          ...
          <div className="rounded-3xl border border-white/5 bg-gradient-to-b from-[#0a0c16]/50 to-[#03050c]/80 p-6 shadow-[0_12px_40px_rgba(0,0,0,0.5)] backdrop-blur-xl relative">
            ...
            <h2 className="font-display font-black text-xs tracking-widest text-slate-300 uppercase mb-5 border-b border-white/5 pb-4">Tài Khoản Ký Quỹ (Escrow)</h2>
            ...
            <div className="space-y-3.5">
              <div className="flex justify-between items-center text-xs">
                <div className="flex items-center gap-2.5">
                  ...
                  <span className="text-slate-400 font-medium">Ký Quỹ Đang Khóa</span>
                </div>
